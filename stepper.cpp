...
volatile long endstops_trigsteps[]={0,0,0,0};//changed by kz
volatile long endstops_stepsTotal,endstops_stepsDone;
static volatile bool endstop_x_hit=false;
static volatile bool endstop_y_hit=false;
static volatile bool endstop_z_hit=false;
static volatile bool endstop_e_hit=false;//added by kz
...
static bool old_e_min_endstop=false;//added by kz
static bool old_e_max_endstop=false;//added by kz
...
//Added block by kz
    if ((out_bits & (1<<E_AXIS)) != 0) {   // -direction
      ...
      CHECK_ENDSTOPS
      {
          #if defined(E0_MAX_PIN) && E0_MAX_PIN > -1
          bool e_max_endstop=(READ(E0_MAX_PIN) != E_MAX_ENDSTOP_INVERTING);
