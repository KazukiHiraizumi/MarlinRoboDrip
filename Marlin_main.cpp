...
static const PROGMEM type array##_P[4] =        \
    { X_##CONFIG, Y_##CONFIG, Z_##CONFIG, E_##CONFIG };     \
...
#define HOMEAXIS_DO(LETTER) \
  ...
  if (axis==X_AXIS ? HOMEAXIS_DO(X) :
      ...
      axis==E_AXIS ? HOMEAXIS_DO(E0) : //added by kz
      0) {
...
void process_commands()
{
  ...
  if(code_seen('G'))
  {
    ...
    case 28: //G28 Home all Axis one at a time
      ...
      home_all_axis = !((code_seen(axis_codes[0])) || (code_seen(axis_codes[1])) || (code_seen(axis_codes[2])) || (code_seen(axis_codes[3])));//added axis_codes[3] by kz
